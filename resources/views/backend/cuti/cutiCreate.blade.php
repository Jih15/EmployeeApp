<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Tambahkan Data Cuti</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
        </button>
    </div>
    <div class="modal-body">
        <form method="POST" action="/cuti" novalidate="novalidate">
            @csrf
            ...
            <div class=" mb-3 form-group">
                ...
                <div class="col-form-check mt-1">
                    <input class="col-form-check-input @error('status') is-invalid @enderror" name="status" value="Telah Selesai" type="radio" id="status_selesai">
                    <label class="col-form-check-label" for="status_selesai">
                        Telah Selesai
                    </label>
                </div>
                <div class="col-form-check">
                    <input class="col-form-check-input @error('status') is-invalid @enderror" name="status" value="Dalam Masa Cuti" type="radio" id="status_cuti">
