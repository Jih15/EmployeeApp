...
function ErrorBanner({ message }: { message: string }) {
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12.5, color: "var(--ruby)", lineHeight: 1.5 }}>
        {message}
      </div>
    </div>
  );
...
export default function LoginPage() {
  ...
  function validateFields(): FormErrors {
    ...
    if (password.length < 6) errs.password = "Password terlalu pendek.";
    return errs;
  }
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Map error code ke pesan Indonesia yang user-friendly
      const errorMessages: Record<string, string> = {
        ...
        TOKEN_EXPIRED: "Sesi telah habis. Silakan login ulang.",
      };

      setApiError(
        errorMessages[apiErr?.error_code] ??
          apiErr?.message ??
      ...
      <div className="auth-right">
        ...
        <form noValidate onSubmit={handleSubmit}>
          <div className="auth-field-group auth-anim-3">
            ...
            <div>
              ...
              <div className="auth-field-wrap">
                ...
                <input
                  className={`f-input${fieldErrors.email ? " auth-input-error" : ""}`}
                  type="email"
            ...
            <div>
              ...
              <div className="auth-field-wrap">
                ...
                <input
                  className={`f-input${fieldErrors.password ? " auth-input-error" : ""}`}
          ...
          <div className="auth-role-hint auth-anim-4">
            ...
            >
              Hanya role di atas yang diizinkan
            </div>
          </div>
